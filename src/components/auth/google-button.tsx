...
export function GoogleButton({ onClick, disabled }: GoogleButtonProps) {
  return (
    <button
      ...
      onClick={onClick}
      disabled={disabled}
      className="flex h-10 w-full items-center justify-center gap-3 border border-[#747775] bg-white px-3 text-[14px] font-medium text-[#1F1F1F] hover:bg-[#F8F9FA] disabled:opacity-60"
...
function GoogleMark() {
  return (
    <svg viewBox="0 0 18 18" className="h-[18px] w-[18px]" aria-hidden>
      ...
      <path
        fill="#FBBC05"
        d="M3.97 10.71A5.4 5.4 0 0 1 3.69 9c0-.6.1-1.17.28-1.71V4.96H.96A9 9 0 0 0 0 9c0 1.45.35 2.82.96 4.04l3.01-2.33Z"
      />
      <path
        fill="#EA4335"
